...
<Image src={screenshot1} alt='"Hello, world!" from a blank page' format="png"/>
...
<Image src={screenshot2} alt='React rendering the application' format="png"/>
...
<Image src={screenshot3} alt='Counter rendering on the client' format='png' />
<Image src={screenshot4} alt='App rendering on the server' format='png' />
