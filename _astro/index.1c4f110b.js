import{c as l,s as r,r as d,m as p,g as a}from"./_astro_assets.c9893cd2.js";import{u as c}from"./hoisted.828b0d8f.js";import"./astro-assets-services.685f5bc4.js";const h={src:"/_astro/logo.1c6fa3ee.png",width:512,height:512,format:"png"},u={src:"/_astro/about-astro.850f94c9.png",width:249,height:450,format:"png"},g=async function(){return{"./logo.png":await a({src:h}),"@/assets/about-astro.png":await a({src:u})}};async function f(t){return g().then(e=>t.replaceAll(/__ASTRO_IMAGE_="([^"]+)"/gm,(i,n)=>r({src:e[n].src,...e[n].attributes})))}const o=await f(`<h2 id="this-is-a-h2-heading">This is a H2 Heading</h2>
...
</section>`),m={title:"A post of Markdown elements",description:"This post is for testing and listing a number of different markdown elements",publishDate:"22 Feb 2023",tags:["test","markdown"],minutesRead:"2 min read"},b="/Users/matt/Desktop/nealmm.github.io/src/content/post/markdown-elements/index.md",F=void 0;function x(){return`
